...
<body>
	...
	<FORM Action="view.jsp" Method="get">
		<%
			if (Page != 1) {
				out.print("<a href=view.jsp?Page=1>第一页</a>");
				out.print("<a href=view.jsp?Page=" + (Page - 1) + ">上一页</a>");
			}
			if (Page != totalPage) {
				out.print("<a href=view.jsp?Page=" + (Page + 1) + ">下一页</a>");
				out.print("<a href=view.jsp?Page=" + totalPage + ">最后一页</a>");
			}
		%>
