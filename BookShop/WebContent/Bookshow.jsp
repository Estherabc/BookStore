...
body {
	...
	<%
		...
		String selsql = "select * from book where BookNum=0";
...
<table border="1" width="900" rules="none" cellspacing="0" cellpadding="0">
 ...
 <%
			...
			for (int iPage = 1; iPage <= PageSize; iPage++){
		    		%>
		    		  <tr height="100" align="center">
		    		    ...
		    		    <td><a href="Bookdocar.jsp?action=buy&id=<%=rs.getString("BookId")%>">预订</a></td>
		    		    </tr>
		    		    <%
		    		    if(!rs.next())
							break;
	...
	<FORM Action="view.jsp" Method="get">
		<%
			if (Page != 1) {
				out.print("<a href=Bookshow.jsp?Page=1>第一页</a>");
				out.print("<a href=Bookshow.jsp?Page=" + (Page - 1) + ">上一页</a>");
			}
			if (Page != totalPage) {
				out.print("<a href=Bookshow.jsp?Page=" + (Page + 1) + ">下一页</a>");
				out.print("<a href=Bookshow.jsp?Page=" + totalPage + ">第一页</a>");
			}
		%>
 ...
 <tr height="50">
   <td align="center" colspan="7"><a href="Bookshopcar.jsp">查看预定书单</a></td>
   </tr>
</table>
